...
Six months ago, I documented a workflow I dialed in on this post: *[How to Vibe Code Like a Software Architect](https://jnakano.com/blog/how-to-vibe-code-like-a-software-architect/)*: PRD → Task Master → Cursor + Sonnet → Repo Prompt → Google AI Studio → GitHub.  \
 \
